...
real*8::lengtha,lengthb,lengthc
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
if (metal_shape(1:6)=="sphere") then
!radius0=10.d-9		!10nm
!radius0=25.d-9
radius0=radiusSphere
...
elseif(metal_shape(1:5)=="block") then

lengtha=20.d-9		!20nm
lengthb=10.d-9		!10nm
lengthc=10.d-9		!10nm
write(6,*) 'a length',lengtha*1d9,'(nm)'
write(6,*) 'b length',lengthb*1d9,'(nm)'
write(6,*) 'c length',lengthc*1d9,'(nm)'
...
call input_metal_para('block',centerx,centery,centerz,0.d0,size1,size2,size3,eps_b,omg_p,gam_0,sigm_0,&
		        depsr_0_1,omega_0_1,gamma_0_1,depsr_0_2,omega_0_2, gamma_0_2,l_n)


if(Mole_type >0) then
molex=(lengtha/2.0+separation)/l_n
moley=0.d0
molez=0.d0
...
call out_point('Ex_inc',0.d0,0.d0,0.d0,0,dd,'inc_Ex.dat')
!xx
...
!if(mod(t,20)==0 .and. (dble(t)/dd)>0.07d0 .and. (dble(t)/dd)<0.15d0) then
!    call  out_plane_cut('Ex' ,'z',0.d0,'xyEx.dat')
!    call  out_plane_cut('E^2','z',0.d0,'xyE2.dat')
!    call  out_plane_cut('E^2','y',0.d0,'xzE2.dat')
!endif
if (dofft .and. mod(t,5000)==0) then
    call  out_plane_cut_w('Gamma',measureLambda,'z',0.d0,'xyE2w.dat')
    call  out_point_w('Ex_inc^2',0.30d0,'Exinc2.dat')
    call  out_point_w('E^2',0.30d0,'E2.dat')
    call  out_point_w('GammaE',0.30d0,'gammaE.dat')
endif
