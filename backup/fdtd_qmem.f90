...
implicit none
integer::i
real*8::TF_SF_box(3,2),radius0,radius1,height,gap,centerx,centery,centerz,thickness,zpos,molex,moley,molez
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
moley=0.d0
molez=zpos
call Molecular_struct('point',molex,moley,molez,0.d0,0.d0,0.d0,1) !xrad
!--Graphene layer
thickness=10.d-9
centerx=0.d0
centery=0.d0
