...
!call monitor(0.d0,0.d0,0.d0,size1,size2,size3)
!--Time propagation	
zpos1=-(height)*0.5d0/l_n-0.1
zpos2= (height)*0.5d0/l_n+0.1
...
!-plane & point  probe
  ...
  if (mod(t,interval)==0 ) then
    call  out_plane_cut('E^2','z',-height/l_n*0.5,'botE2.dat')
    call  out_plane_cut('E^2','z',-height/l_n*0.5+0.01,'inE2.dat')
    call  out_plane_cut('E^2','x',0.d0,'x0E2.dat')
    call  out_plane_cut('E^2','y',0.d0,'y0E2.dat')
...
!!x max point
call out_line_z('Ex',radius0/l_n,0.d0,zpos1,zpos2,0,dd,'xradExline.dat')
call out_line_z('Ey',radius0/l_n,0.d0,zpos1,zpos2,0,dd,'xradEyline.dat')
call out_line_z('Ez',radius0/l_n,0.d0,zpos1,zpos2,0,dd,'xradEzline.dat')

!!y max point
call out_line_z('Ex',0.d0,radius0/l_n,zpos1,zpos2,0,dd,'yradExline.dat')
call out_line_z('Ey',0.d0,radius0/l_n,zpos1,zpos2,0,dd,'yradEyline.dat')
call out_line_z('Ez',0.d0,radius0/l_n,zpos1,zpos2,0,dd,'yradEzline.dat')
!!central point
call out_line_z('Ex',0.d0,0.d0,zpos1,zpos2,0,dd,'cenExline.dat')
call out_line_z('Ey',0.d0,0.d0,zpos1,zpos2,0,dd,'cenEyline.dat')
call out_line_z('Ez',0.d0,0.d0,zpos1,zpos2,0,dd,'cenEzline.dat')
