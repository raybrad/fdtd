...
radius0=10.d-9		!center
radius1=10.d-9		!around
height =20.d-9		
gap=2.d-9	!gap=110.d-9
...
size2=height/l_n
do i=1,6
centerx=(radius0+gap+radius1)*cos(pi/3.0*(i-1))/l_n
centery=(radius0+gap+radius1)*sin(pi/3.0*(i-1))/l_n
