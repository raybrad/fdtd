...
implicit none
integer::i
real*8::TF_SF_box(3,2),radius0,radius1,height,gap,centerx,centery,centerz,thickness,size1,size2,size3
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
size2=(TF_SF_box(2,2)-0.05)*2.d0
size3=(TF_SF_box(3,2)-0.05)*2.d0
call out_point('Ex',size1*0.5d0,0.d0,0.d0,0,dd,'inEx.dat')
call out_point('Hy',size1*0.5d0,0.d0,0.d0,0,dd,'inHy.dat')
!call Poynting_block_in('absorb.dat',0.d0,0.d0,0.d0,size1,size2,size3,0,dd)
!size1=(TF_SF_box(1,2)+0.05)*2.d0
!size2=(TF_SF_box(2,2)+0.05)*2.d0
!size3=(TF_SF_box(3,2)+0.05)*2.d0
!call out_point('Ex',size1*0.5d0,0.d0,0.d0,0,dd,'outEx.dat')
!call out_point('Hy',size1*0.5d0,0.d0,0.d0,0,dd,'outHy.dat')
!call Poynting_block_out('scatter.dat',0.d0,0.d0,0.d0,size1,size2,size3,0,dd)


!call incident_intensity(ksize/2,0,dd)
