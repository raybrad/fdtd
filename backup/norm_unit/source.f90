...
integer:: k           !// at 3*tdecay Gaussian=0.001 !// 
	k=floor(0.5+(z0+zcenter)*(lattice_z-1)) +1
...
!//////////////////////////////////////////////////////////////////////////  
	...
	TF_SF_pos(1,1)= floor(0.5+(rpos(1,1)+xcenter)*(lattice_x-1))+1
	TF_SF_pos(1,2)= floor(0.5+(rpos(1,2)+xcenter)*(lattice_x-1))+1
	TF_SF_pos(2,1)= floor(0.5+(rpos(2,1)+ycenter)*(lattice_y-1))+1
	TF_SF_pos(2,2)= floor(0.5+(rpos(2,2)+ycenter)*(lattice_y-1))+1
	TF_SF_pos(3,1)= floor(0.5+(rpos(3,1)+zcenter)*(lattice_z-1))+1
	TF_SF_pos(3,2)= floor(0.5+(rpos(3,2)+zcenter)*(lattice_z-1))+1
