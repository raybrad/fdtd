...
!-plane & point  probe
  ...
  if (mod(t,interval)==0 ) then
    call  out_plane_cut('Ex','z',-height/l_n*0.5,'botEx.dat')
    call  out_plane_cut('Ey','z',-height/l_n*0.5,'botEy.dat')
    call  out_plane_cut('Ez','z',-height/l_n*0.5,'botEz.dat')
...
!!x max point
call out_point('Ex',radius0/l_n,0.d0,-height/l_n*0.5,0,dd,'xradEx.dat')
call out_point('Ey',radius0/l_n,0.d0,-height/l_n*0.5,0,dd,'xradEy.dat')
call out_point('Ez',radius0/l_n,0.d0,-height/l_n*0.5,0,dd,'xradEz.dat')

!!y max point
call out_point('Ex',0.d0,radius0/l_n,-height/l_n*0.5,0,dd,'yradEx.dat')
call out_point('Ey',0.d0,radius0/l_n,-height/l_n*0.5,0,dd,'yradEy.dat')
call out_point('Ez',0.d0,radius0/l_n,-height/l_n*0.5,0,dd,'yradEz.dat')
!!central point
call out_point('Ex',0.d0,0.d0,-height/l_n*0.5,0,dd,'cenEx.dat')
call out_point('Ey',0.d0,0.d0,-height/l_n*0.5,0,dd,'cenEy.dat')
call out_point('Ez',0.d0,0.d0,-height/l_n*0.5,0,dd,'cenEz.dat')
